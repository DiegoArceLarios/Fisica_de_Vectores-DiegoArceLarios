...
export default class Escalar extends Component{
    ...
    igual(){
        const{number1,number2,number3,number4,operacion}=this.state
        
        if(operacion===1){
            this.setState({
                resultado1:number1*number4,
                resultado2:number2*number4,
                resultado3:number3*number4
            })
        }
        if(operacion===2){
            this.setState({
                ...
                <ScrollView style={{flex: 1, borderBottomWidth: 3, borderColor: 'white'}}>
                    <View style={{justifyContent: 'center', marginTop: 40, margin: 10}}>
                        ...
                        <Text style={{color: 'white', fontSize: 15, fontWeight: 'bold'}}>
                            x = multiplicación vector-escalar
                        </Text>
                        <Text style={{color: 'white', fontSize: 15, fontWeight: 'bold'}}>
